...
;crée l'environnement pour un let au top level
...
(let ((liste ()))
(defun compile (expr &optional fichier)
  (setf liste ())
  (if (atom expr)
      ()
    (to_asm expr () t ()))
...
;Compile les expressions passées dans le let
...
;Compile les expressions passées en parametre
